...
return [
    ...
    'attributes' => [
        ...
        'bank_name' => 'bank név',
        'billed_company.name' => 'partner név',
        'billed_company.tax_number' => 'partner adószám',
        'billing_company_id' => 'számlázó cég',
        'billing_items.0.item_id' => 'tevékenység',
        'billing_items.0.unit_id' => 'mértékegység',
        'change_rate_id' => 'árfolyam',
        'currency_id' => 'pénznem',
        'due_date' => 'fizetési határidő',
        'issued_date' => 'teljesítés dátum',
        'status_id' => 'státusz',
        'lang' => 'nyelv',
        'signkey' => 'aláírás kulcs',
        'exchangekey' => 'csere kulcs',
        'iban' => 'IBAN',
        'exchange_rate' => 'árfolyam',
        'payment_method' => 'fizetési mód',
        'recurring_type' => 'ismétlődő típus',
        'billed_company.email' => 'számlázott cég e-mail címe',
        'billed_company.phone' => 'számlázott cég telefonszáma',
        'billed_company.city' => 'számlázott cég városa',
        'billed_company.country' => 'számlázott cég országa',
        'billed_company.postal_code' => 'számlázott cég irányítószáma',
        'billed_company.address' => 'számlázott cég címe',
        'billing_items.0.order' => 'számlázási tételek sorrendje',
        'billing_items.0.net_unit_price' => 'számlázási tételek nettó egységára',
        'billing_items.0.quantity' => 'számlázási tételek mennyisége',
        'billing_items.0.vat' => 'számlázási tételek áfája',
        'billing_items.0.discount' => 'számlázási tételek kedvezménye',
        'billing_items.0.unit_price' => 'számlázási tételek egységára',
        'billing_items.0.net_total' => 'számlázási tételek nettó összege',
        'billing_items.0.total_price' => 'számlázási tételek teljes ára',
        'billing_items.0.vat_amount' => 'számlázási tételek áfa összege',
        'billing_items.0.gross_total' => 'számlázási tételek bruttó összege',
        'billing_items.0.description' => 'számlázási tételek leírása',
        'summary.total_due' => 'összegzés fizetendő összesen',
        'summary.discount' => 'összegzés kedvezmény',
        'summary.vat_amount' => 'összegzés áfa összege',
        'summary.total' => 'összegzés teljes összeg',
        'sales_person' => 'értékesítő',
        'sales_message' => 'értékesítési üzenet',
        'invoice_template_name' => 'számlasablon neve',
        'invoice_template_data' => 'számlasablon adatai',
        'associateEmail' => 'munkatárs e-mail címe',
        'birthdate' => 'születési dátum',
        'terms_and_conditions' => 'feltételek és kikötések',
        'owner' => 'tulajdonos',
        ...
        'zip' => 'irányítószám',
        'public_place_id' => 'közterület azonosító',
        'place_number' => 'hely száma',
        'floor_or_door' => 'emelet vagy ajtó',
    ],
];
